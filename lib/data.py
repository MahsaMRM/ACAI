...
_DATASETS = {
    ...
    'font512_train':
        functools.partial(
            input_fn_record,
            _parser_all,
            [os.path.join(DATA_DIR, 'font-train.tfrecord')],
            size=(28, 28, 1),
            pad=(2, 2),
            resize=(32, 32)),
    ...
    'font512_test':
        functools.partial(
            input_fn_record,
            _parser_all,
            [os.path.join(DATA_DIR, 'font-test.tfrecord')],
            shuffle=False,
            repeat=False,
            size=(28, 28, 1),
            pad=(2, 2),
    ...
    'fire_leaf_train':
        functools.partial(
            input_fn_record,
            _parser_all,
            [os.path.join(DATA_DIR, 'fire_leaf-train.tfrecord')],
            size=(28, 28, 1),
            pad=(2, 2),
            resize=(32, 32)),
    ...
    'fire_leaf_test':
        functools.partial(
            input_fn_record,
            _parser_all,
            [os.path.join(DATA_DIR, 'fire_leaf-test.tfrecord')],
            shuffle=False,
            repeat=False,
            size=(28, 28, 1),
            pad=(2, 2),
